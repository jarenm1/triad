//! PLY file loading with GPU type conversion
//!
//! This module provides functions to load PLY files and convert them to GPU-specific
...
// Re-export PlyVertex from triad-data for convenience
pub use triad_data::PlyVertex;

// Face structure for PLY files (needed for load_triangles_from_ply)
